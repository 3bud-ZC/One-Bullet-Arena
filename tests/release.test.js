...
test('release metadata exposes the canonical smooth runtime identity', () => {
  assert.equal(RELEASE_VERSION, '3.14.0-cinematic-combat');
  assert.equal(RELEASE_LABEL, 'v3.14.0-cinematic-combat');
  assert.equal(RELEASE_CACHE_NAME, 'one-bullet-arena-v3.14.0-cinematic-combat');
