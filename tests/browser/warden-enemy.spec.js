...
test('warden runtime boots beneath global UI and wave seven introduces the enemy', async ({ page }) => {
  ...
  expect(result.menu.releaseVersion).toBe('3.14.0-cinematic-combat');
  ...
  expect(result.menu.visualOverhaulActive).toBe(true);
  expect(result.menu.expandingWorldActive).toBe(true);
