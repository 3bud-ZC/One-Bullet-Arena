...
test('release metadata exposes the canonical smooth runtime identity', () => {
  assert.equal(RELEASE_VERSION, '3.12.1-health-readability');
  assert.equal(RELEASE_LABEL, 'v3.12.1-health-readability');
  assert.equal(RELEASE_CACHE_NAME, 'one-bullet-arena-v3.12.1-health-readability');
