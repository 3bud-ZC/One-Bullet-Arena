...
test('release metadata exposes the canonical smooth runtime identity', () => {
  assert.equal(RELEASE_VERSION, '3.13.0-combat-vfx');
  assert.equal(RELEASE_LABEL, 'v3.13.0-combat-vfx');
  assert.equal(RELEASE_CACHE_NAME, 'one-bullet-arena-v3.13.0-combat-vfx');
