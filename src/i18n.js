...
const EN = Object.freeze({
  ...
  'upgrade.after': 'After',
  'guardian.sentinel.name': 'Sentinel',
  'guardian.bastion.name': 'Bastion',
  'guardian.harrier.name': 'Harrier',
  'guardian.phase.stalk': 'Exposed',
  'guardian.phase.wind': 'Winding up',
  'guardian.phase.strike': 'Striking',
...
const AR = Object.freeze({
  ...
  'guardian.sentinel.name': 'الحارس',
  'guardian.bastion.name': 'الحصن',
  'guardian.harrier.name': 'المُغِير',
  'guardian.phase.stalk': 'مكشوف',
  'guardian.phase.wind': 'يستعد',
  'guardian.phase.strike': 'يهجم',
