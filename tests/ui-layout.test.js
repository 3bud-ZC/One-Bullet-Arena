...
import { UI_LAYOUT_VERSION, compactHudLayout } from '../src/ui-layout-runtime.js';

test('UI layout patch exposes its release identifier', () => {
  assert.equal(UI_LAYOUT_VERSION, '2.7.1-ui');
});
