...
test('release metadata exposes the canonical smooth runtime identity', () => {
  assert.equal(RELEASE_VERSION, '3.15.0-arena-polish');
  assert.equal(RELEASE_LABEL, 'v3.15.0-arena-polish');
  assert.equal(RELEASE_CACHE_NAME, 'one-bullet-arena-v3.15.0-arena-polish');
